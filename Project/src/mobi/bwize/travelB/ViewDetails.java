 ...
 * Description:
 * 
 * Same as AddTrip, except there are no spinners and other values 
 * are prepopulated. Includes ability to delete trip.
 * 
 * For section that are the same as AddTrip, please see comments in AddTrip
 * 
 */
...
public class ViewDetails extends FragmentActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// cancel button - acts as delete button here
		// Includes confirmation dialog as well as deleting
		// any tasks related to the trip
	...
	public void saveTrip(View view) {
		...
		try {
			db.open();
			// Update trip by id instead of creating a new entry
	...
	// Same as AddTrip - see comments there
